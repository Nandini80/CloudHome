...
useEffect(() => {
  const fetchData = async () => {
    ...
    // alert(JSON.stringify({ email: eml }));
    const emailCheck = { email: eml };
    const data = await GetItems(emailCheck);
    setObj2(data);
    // alert(JSON.stringify(obj2.data.data.image));  // Use obj2 here, not obj
  };
